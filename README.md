...
MeyREN Gateway یک تونل VLESS روی WebSocket است که روی Render (هاست رایگان) اجرا می‌شود.

نیازی به سرور VPS ندارید. فقط کافیه پروژه را از [مخزن MeyREN](https://github.com/meytiii/MeyREN) فورک کنید و روی Render دیپلوی کنید.
...
- 💾 برخلاف نسخه‌های قبلی، اطلاعات کاربران و رمز عبور در دیتابیس SQLite ذخیره می‌شود و با ری‌استارت سرور پاک نمی‌شود
